                ...
                <div class='box'>
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-lefth ui-sortable-handle">
                            ...
                            <li class=""><a href="#chamado_concluido" data-toggle="tab"
                                            aria-expanded="false">Concluidos</a>
                            </li>
                            <li class=""><a href="#chamado_pedido" data-toggle="tab" aria-expanded="false">Enviados</a>
                            </li>
                        </ul>
                    </div>
